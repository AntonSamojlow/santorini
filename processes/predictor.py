    ...
    def run(self):
        ...
        try:       
            ...
            with tf.device(tf_device): 
                ...
                self.logger.info("tf.keras.model (iteration {}) loaded from {}, awaiting requests...".format(model_iteration, self.gympath.model_folder))
                while not self.endevent.is_set():
                    if self.newmodelevent.is_set():
                        ...
                        self.logger.info("tf.keras.model (iteration {}) reloaded from {}, awaiting requests...".format(model_iteration, self.gympath.model_folder))
                    ...
                    if len(requests) > 0:
                        ...
                        for i in range(len(requests)):
                            ...
                            self.response_qs[requester_selfplayername].put([requester_thread_id, prediction])
